...
import { LogOut, GraduationCap, LayoutDashboard, BookOpen, ClipboardList, Users, Clock, Phone, Bell, Settings } from 'lucide-react';
      ...
      <div className="border-b border-white/10 px-4 py-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-white/50">Faculty Portal</p>
          </div>
        </div>
      </div>
